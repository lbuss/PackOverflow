...
Question.create!([
  {title: "Hiking Shoes for Unevenly Sized Feet?", body: "So, I have one foot that is much larger than the other. I love the outdoors, but hiking for too long gets very uncomfortable. I guess I am looking for any suggestions anyone may have.", answer_id: nil, user_id: 3, vote_count: nil},
  {title: "Sharpening Tools in the Backcountry", body: "So, I was recently on a trip where my knife blade got really dull. What's the best way to make sure I can always have that razor edge?", answer_id: nil, user_id: 2, vote_count: 1},
  {title: "What are some good/trustworthy brands for water filters?", body: "Hey. I am planning on buying a new water filter soon. I will probably get a pump one as they are reliable but don't taste too bad (as opposed to the UV lamps which can break or the tablets which taste bad). Any recommendations?", answer_id: nil, user_id: 5, vote_count: nil},
  {title: "What is a good size for my first backpacking pack?", body: "Hello,<div><br></div><div>I was wondering what people recommended for a first backpacking pack. I will probably only do weekend trips with 1-3 other people to start out with, however I would like to be able to carry the essentials for a solo trip in case I would like to do that later.&nbsp;</div><div><br></div><div>Thanks!&nbsp;</div>", answer_id: nil, user_id: 2, vote_count: 2},
